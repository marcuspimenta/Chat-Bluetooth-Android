...
public class ChatActivity extends RoboActivity{
	...
	public void configView(){
		...
		btnClient.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				progressDialog = ProgressDialog.show(ChatActivity.this, "Aguarde", "Procurando dispositivos...");
		...
		switch (requestCode) {
			...
			case BT_VISIBLE:
				if (resultCode == BT_TIMER_VISIBLE) {
					...
					bluetoothServiceTask = new BluetoothServiceTask(ChatActivity.this, adaptador, handler, 1); 
	...
	private void exibirDispositivosEncontrados() { 
		...
		AlertDialog.Builder dialog = new AlertDialog.Builder(this).setTitle("Aparelhos encontrados").setItems(aparelhos, new OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				bluetoothClientTask = new BluetoothClientTask(ChatActivity.this, handler, 1);
